...
3) Access the `workbench` named `audio-to-text-p1731926558245-notebook`.
...
5) In the terminal, run `cd audio-to-text-p1731926558245` to navigate to your sample app's directory.
